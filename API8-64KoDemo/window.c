...
static GL4DHanime _animations[] = {
  ...
  //{ 5000, bleu, NULL, NULL },
  { 6500, strip, NULL, transition_fondu },
  { 500, vert, rouge, fondu },
  { 4000, tran, NULL, transition_fondu },
  { 4000, bwhite, NULL, NULL },
  { 2000, mandelbro, NULL, NULL },
  { 4500, animation_mendel, NULL, NULL },
  { 300, rowling, NULL, NULL },
    { 1000, rouge, vert, fondu },
   { 1000, vert, bleu, fondu },
   { 1000, vert, rouge, fondu },
  { 4500, strip, NULL, transition_fondu },
  { 6000, credit_fin, NULL, NULL },
...
int main(int argc, char ** argv) {
  if(!gl4duwCreateWindow(argc, argv, "API8 - démo", 
